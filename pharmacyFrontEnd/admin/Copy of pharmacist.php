...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-10">
			<form id="form1" name="form1" onsubmit="addNewUsers()" method = "post" class="form-horizontal" enctype="multipart/form-data">
				<div class="form-group">
				    <div class="input-group">
				    	<span class="input-group-addon">First Name</span>
						<input name="firstname" type="text" class="form-control" id="fr_itemname" placeholder="Pharmacy Name..."/>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
				    	<span class="input-group-addon">Last Name</span>
						<input name="lastname" type="text" class="form-control" id="fr_price" placeholder="Obtained Qualification..." />
					</div>
				</div>
